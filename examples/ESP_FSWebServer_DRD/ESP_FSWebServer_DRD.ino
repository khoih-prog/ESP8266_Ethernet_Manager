...
void setup()
{
  ...
  Serial.println(ESP8266_ETH_MANAGER_VERSION);
  ...
  //ESP8266_Ethernet_Manager ESP8266_Ethernet_manager(&webServer, &dnsServer);
  // Use this to personalize DHCP hostname (RFC952 conformed)
  ESP8266_Ethernet_Manager ESP8266_Ethernet_manager("ESP-FSWebServer_DRD");

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  ESP8266_Ethernet_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //ESP8266_Ethernet_manager.setConfigPortalTimeout(600);
